...
public class UpdateNewsService {
    /**
     * 同步策略: 1.返回当前的最新新闻， 2.如果点击更多，同步他上次同步的到今天最新的之间的新闻。 3.每次每个类别返回<=30条最新的，如果最新的不够30，返回实际条数
     * 
     * @return JSON格式的新闻列表
     */
    public String get(long[] lastIds, String[] categories) {
        // dao query returns Map<category,List<News>>
        NewsDao newsDao = new NewsDao();
        Map<String, List<News>> res = newsDao.getLastNewsBatch(lastIds, categories);
        // convert to JSON
